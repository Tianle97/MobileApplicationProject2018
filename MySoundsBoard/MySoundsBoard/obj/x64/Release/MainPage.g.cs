#pragma checksum "C:\Quella\MobileApplicationProject2018\MySoundsBoard\MySoundsBoard\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "FD18C3743E37A698158FFA9EA15CE33B"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace MySoundsBoard
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::MySoundsBoard.Model.MenuItem dataRoot;
            ...
            {
                 global::MySoundsBoard.Model.MenuItem data = args.NewValue as global::MySoundsBoard.Model.MenuItem;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::MySoundsBoard.Model.MenuItem was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::MySoundsBoard.Model.MenuItem);
                ...
                this.Update_((global::MySoundsBoard.Model.MenuItem) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::MySoundsBoard.Model.MenuItem newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::MySoundsBoard.Model.MenuItem obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Category(global::MySoundsBoard.Model.SoundCategory obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj10_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::MySoundsBoard.Model.Sound dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void DataContextChangedHandler(global::Windows.UI.Xaml.FrameworkElement sender, global::Windows.UI.Xaml.DataContextChangedEventArgs args)
            {
                 global::MySoundsBoard.Model.Sound data = args.NewValue as global::MySoundsBoard.Model.Sound;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::MySoundsBoard.Model.Sound was expected.");
                 }
                 this.SetDataRoot(data);
                 this.Update();
            }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::MySoundsBoard.Model.Sound);
                        if (!removedDataContextHandler)
                        {
                            removedDataContextHandler = true;
                ...
                this.Update_((global::MySoundsBoard.Model.Sound) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::MySoundsBoard.Model.Sound newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::MySoundsBoard.Model.Sound obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::MySoundsBoard.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void SetDataRoot(global::MySoundsBoard.MainPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::MySoundsBoard.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Menus(global::System.Collections.Generic.List<global::MySoundsBoard.Model.MenuItem> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Sounds(global::System.Collections.ObjectModel.ObservableCollection<global::MySoundsBoard.Model.Sound> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 3:
                {
                    ...
                    ((global::Windows.UI.Xaml.Controls.ListView)this.MenuItem).ItemClick += this.MenuItemsListView_ItemClick;
                    #line default
                }
                break;
            case 7:
            ...
            case 4:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::MySoundsBoard.Model.MenuItem) element4.DataContext);
            ...
            case 10:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::MySoundsBoard.Model.Sound) element10.DataContext);
